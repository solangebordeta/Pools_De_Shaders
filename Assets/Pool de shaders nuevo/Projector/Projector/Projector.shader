	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				finalColor = tex2D( _RenderImage, ( ( appendResult5 / break4.w ) + float4( ( ( normalizeResult34 * ( dotResult37 * _Scale ) ) + _Vector1 ), 0.0 , 0.0 ) ).xy );
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=18900
232;73;1336;622;2314.372;949.8567;3.242214;True;False
...
ASEEND*/
//CHKSM=23F8EFBC826E57A7EEB2B5FE843ADD5A79EB3014