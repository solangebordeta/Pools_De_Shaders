...
Shader "egr"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float3 Ripple29 = ( (0.0 + (sin( ( ( distance( ase_worldPos , _CollisionWaves2 ) + _Time.y ) * _Frequency2 ) ) - 0.0) * (1.0 - 0.0) / (1.0 - 0.0)) * _DeformationVector * _Height2 );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 Albedo28 = ( _Color0 + CalculateContrast(1.74,temp_cast_3) );
...
/*ASEBEGIN
Version=18900
255;73;1215;586;3152.627;1158.917;2.946514;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-1926.242,-131.9021;Inherit;False;Constant;_TimeScale;Time Scale;10;0;Create;True;0;0;0;False;0;False;1;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;4;-2085.33,-690.3826;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;5;-2045.073,-582.7012;Inherit;False;Constant;_Vector1;Vector 1;3;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;7;-1915.516,-684.3818;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0.3,-0.27;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;11;-1880.554,-532.0461;Inherit;False;Constant;_Speed;Speed;9;0;Create;True;0;0;0;False;0;False;1;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-1210.336,-268.441;Inherit;False;Constant;_Weight;Weight;11;0;Create;True;0;0;0;False;0;False;0.14;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;23;-730.3534,-654.4298;Inherit;False;Property;_Color0;Color 0;9;0;Create;True;0;0;0;False;0;False;0.4862745,0.6816209,1,0;0.4862745,0.6816209,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector3Node;22;-194.011,863.4496;Inherit;False;Property;_DeformationVector;DeformationVector;8;0;Create;True;0;0;0;False;0;False;0,5,0;0,5,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
ASEEND*/
//CHKSM=887BCDDB0F98D9FACEE9DFDB368CDC40AC25FA10